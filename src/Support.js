    ...
    <div className="support-container">
      <div className="support-column">
        <Link to="/contact-us" className="support-link">
          <h2 className="support-title">Contact Us</h2> {/* Make sure to add the title class */}
        </Link>
      ...
      <div className="support-column">
        <Link to="/about-us" className="support-link">
          <h2 className="support-title">About Us</h2> {/* Added Link and title class */}
        </Link>
      ...
      <div className="support-column">
        <Link to="/privacy" className="support-link">
          <h2 className="support-title">Privacy</h2> {/* Added Link and title class */}
        </Link>
